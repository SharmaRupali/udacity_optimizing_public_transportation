...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        #
        #
        topic_name = f"org.chicago.cta.station.arrivals.{station_name}" # adjusted the value according to the one in consumers/server.py # f"com.udacity.project.arrival_station.{station_name}" # TODO: Come up with a better topic name
        super().__init__(
            topic_name,
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        #
        #
        logger.info("arrival kafka integration complete - continuing")
