...
class Line:
    ...
    def process_message(self, message):
        ...
        logger.info("-------------------- Line Message Processor --------------------")
        ...
        elif message.topic == f"org.chicago.cta.station.arrivals.{value.get('STATION_NAME')}": # Set the conditional to the arrival topic
